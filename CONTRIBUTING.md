...
Thank you for considering contributing to KMP-Logger! We welcome contributions of all kinds,
...
5. Ensure all commits are signed using GPG. Unsigned commits will not be accepted. Learn how
...
> Try not to open pull request for minor typos if its not breaking anything in code logics. However,
> feel free to [open an issue](https://github.com/shivathapaa/KMP-Logger/issues/new/choose) for
> reporting it.

When you're ready to submit a pull request:

1. Ensure your code adheres to the style guide. (You can
   refer [Style Guide from Kotlin Docs](https://kotlinlang.org/docs/coding-conventions.html)
   or [Style Guide from Android Devlopers](https://developer.android.com/kotlin/style-guide))
...
This project is licensed under [Apache License 2.0](https://github.com/shivathapaa/KMP-Logger/blob/main/LICENSE)
